...
xline(datetime(2013,3,1,12,45,45),'--b','linewidth',2)
xline(datetime(2015,3,1,12,45,45),'--r','linewidth',2)
xlabel('Date','fontsize',20)
ylabel('Absolute error (km)','fontsize',20)
title('Position error','fontsize',16)
legend('Radial','Along-track','Cross-track','Range','March 2013','March 2015','fontsize',20)
...
legend('Radial','Along-track','Cross-track','Magnitude','March 2013','March 2015','fontsize',20)
...
legend('','March 2013','March 2015','fontsize',20)
